    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* CTA Buttons (Replaced with Reusable Button Component) */}
          <div
          ...
          >
            <Button
              variant="primary"
              className="text-lg px-8 py-4 shadow-glow-hover"
            >
              🚀 Mulai Eksplorasi
            </Button>
            ...
            <Button
              variant="outline"
              className="text-lg px-8 py-4 hover:bg-white/10 text-white"
            >
              📊 Lihat Analytics
            </Button>
          </div>
